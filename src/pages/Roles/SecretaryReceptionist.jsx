...
const SecretaryReceptionist = () => {
  return (
    ...
    <Helmet>
            <title>
             Legal Secretary & Receptionist Services | Boulou LPO
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-6 col-md-9">
              <div className="history__img-wrap-five">
                <img
                  src="assets/img/SecretaryReceptionist.jpg"
                  alt="img"
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="section__title text-center mb-40">
                ...
                <p>
                  Explore reliable Legal Secretary and Receptionist support—
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="section__title text-center mb-40">
                ...
                <p>
                  A remote attorney is not U.S.-based or licensed, but is
                  trained by U.S. attorneys and has experience working with U.S.
                  law firms.
                </p>
              </div>
            </div>
