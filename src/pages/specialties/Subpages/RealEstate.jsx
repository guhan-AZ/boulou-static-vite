...
import real from "../../../../public/assets/img/special/Real-Estate.jpg";
import real1 from "../../../../public/assets/img/newimage/Real Estate Law.jpg";
          ...
          <div className="row align-items-center">
            <div className="col-lg-8 col-md-12 hero-text-content">
              <div className="legal-hero-badge">
                Accurate and Efficient Transaction Support
              </div>
              <h1 className="hero-title">Real Estate Law</h1>
              <p className="hero-description">
                Boulou LPO provides skilled paralegal assistance for real estate
                attorneys, firms, and title companies, ensuring transactions,
                contracts, and filings are completed with accuracy and efficiency.
                From document preparation to closing coordination, we help you keep
                deals moving smoothly while reducing delays and errors.
              </p>
            </div>
            <div className="col-lg-4 col-md-12 hero-image-content">
              <div className="hero-main-image">
                <img src={real1} alt="Real Estate Law" />
              ...
              <p className="hero-caption">
                * At Boulou LPO, our paralegals provide comprehensive real estate
        ...
        <div className="container">
          <div className="row g-5 align-items-start">
            <div className="col-lg-6">
              ...
              >
                How We Can Transform Your Real Estate Practice
              </h2>
            </div>
            <div className="col-lg-6">
              <h6 style={{ color: "#002688" }}>
                From Contract to Closing Without Complications
              </h6>
              <p className="transform-description text-muted">
                Real estate transactions require meticulous attention to detail and
                strict adherence to timelines. Our paralegals streamline your
                workflow by managing documents, coordinating with all parties, and
                tracking every step of the process. With us handling the
                administrative and procedural details, your attorneys can focus on
                negotiation, client relationships, and ensuring favorable outcomes.
              </p>
            </div>
                ...
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      <h5 className="fw-semibold">Document Precision</h5>
                      <p>
                        We prepare and review purchase agreements, leases, and
                        closing documents with meticulous accuracy.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                        Our team coordinates with title companies, lenders, and real
                        estate agents to keep transactions on track.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-12">
                  <div className="transform-card">
                    <img
                      src={cxxinc}
                      className="transform-card-img"
                      alt="Title and Compliance"
                    />
                    <div className="transform-card-overlay"></div>
                    <div className="transform-card-content">
                      <h5 className="fw-semibold">Title and Compliance</h5>
                      <p>
                        We conduct title searches, prepare summaries, and ensure
                        compliance with all transaction deadlines.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="features__item-two">
                ...
                <div className="features__content-four">
                  ...
                  <p>
                    Paralegals trained in real estate transactions, property law,
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="features__item-two">
                ...
                <div className="features__content-four">
                  ...
                  <p>
                    Familiarity with contracts, title searches, and closing
                    processes.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="features__item-two">
                ...
                <div className="features__content-four">
                  ...
                  <p>
                    Secure handling of sensitive client and property records.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-sm-6">
              <div className="features__item-two">
                ...
                <div className="features__content-four">
                  ...
                  <p>
                    Quality paralegal support without the cost of in-house hires.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="row">
                  <div className="col-xl-8 col-lg-8">
                    <div className="banner__content-five" style={{ padding: "30px" }}>
                      ...
                      <h4>Seamless Support for Every Deal</h4>
                      <p data-aos="fade-up" data-aos-delay="600">
                        Boulou LPO ensures your real estate transactions run smoothly
                        from start to finish. We help prevent costly delays, keep all
                        parties informed, and deliver accurate, timely documentation —
                        making us a dependable extension of your real estate law team.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-7 col-md-10">
              <div className="features__content-two">
                <div className="section__title mb-25">
                  ...
                  <h2>Expert Real Estate Law Paralegal Support</h2>
                  <p>
                    At Boulou LPO, our paralegals provide comprehensive real estate
                    legal support, including:
                  </p>
                ...
                <ul className="list-wrap about__list-item-two">
                  <li>
                    ...
                    Preparing and reviewing purchase agreements, leases, and closing
                    documents
                  </li>
                  <li>
                    <div className="icon">
                    ...
                    Coordinating with title companies, lenders, and real estate
                    agents
                  </li>
                  <li>
                    <div className="icon">
                    ...
                    Conducting title searches and preparing title summaries
                  </li>
                  <li>
                    <div className="icon">
                      <svg
                    ...
                    Organizing and filing deeds, mortgages, and other
                  ...
                  <li>
                    ...
                    Managing transaction timelines and ensuring compliance with
                    deadlines
                  </li>
                  <li>
                    <div className="icon">
                    ...
                    Drafting legal correspondence and maintaining transaction
                    records
                  </li>
                </ul>
              </div>
