          ...
          <div className="row align-items-center">
            <div className="col-lg-8 col-md-12 hero-text-content">
              <div className="legal-hero-badge">
                Specialized and Discreet Legal Support
              </div>
        ...
        <div className="container">
          <div className="row g-5 align-items-start">
            <div className="col-lg-6">
              ...
              >
                How We Can Transform Your Education Law Operations
              </h2>
            </div>
            <div className="col-lg-6">
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-5 col-md-10 order-0 order-lg-2">
              <div className="features__img">
                <img src="assets/img/special/Education.jpg" alt="img" />
              </div>
            </div>
