                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-10">
                            <div className="section__title text-center mb-40">
                                <h2 className="title">Municipal / Local Government Law </h2>
                                <p>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-5 col-md-10 order-0 order-lg-2">
                            <div class="features__img">
                                   <img src="assets/img/special/Municipal.jpg" alt="img" />
                            </div>
                        </div>
                            ...
                            <div class="features__item-two">
                                <div class="features__content-four">
                                    <div className="section__title   ">
                                        ...
                                        <h5 className="mt-3">
                                            {/* <i>Efficient Support for Complex Workplace Matters </i>{" "} */}
                                        </h5>
                                        <p>
                            ...
                            <div class="features__item-two">
                                <div class="features__content-four">
                                    <div className="section__title   ">
                                        ...
                                        <h5 className="mt-3">
                                            {" "}
                                            <i> Enhancing Local Government Legal Operations Through Skilled Paralegal Support</i>{" "}
                                        </h5>
                                        <p>
