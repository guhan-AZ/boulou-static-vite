          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-8 col-md-12 hero-text-content">
              <div className="legal-hero-badge">
                Expert Maritime / Admiralty Law Paralegal Support
              </div>
              <h1 className="hero-title">Maritime / Admiralty Law</h1>
              <p className="hero-description">
                Boulou LPO provides specialized paralegal assistance for
                maritime and admiralty law attorneys, ensuring case
                documentation, filings, and regulatory compliance are handled
                accurately and efficiently. From vessel contracts to injury
                claims, we help your firm manage complex legal matters while
                attorneys focus on advocacy and strategy.
              </p>
            </div>
            ...
            <div className="col-lg-4 col-md-12 hero-image-content">
              ...
              <p className="hero-caption">
                At Boulou LPO, our paralegals provide comprehensive maritime law
        ...
        <div className="container">
          <div className="row g-5 align-items-start">
            <div className="col-lg-6">
              ...
              >
                How We Can Transform Your Maritime / Admiralty Law Practice{" "}
              </h2>
            </div>
            <div className="col-lg-6">
              <h6 style={{ color: "#002688" }}>
                Streamlined Support for Complex Maritime Cases
              </h6>
              <p className="transform-description text-muted">
                Maritime and admiralty matters involve strict regulatory
                requirements, deadlines, and multi-party coordination. Our team
                handles filings, documentation, and research efficiently,
                allowing attorneys to focus on negotiations, litigation
                strategy, and client advocacy. This ensures cases proceed
                ...
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    <img
                      ...
                      alt="Maritime Contracts & Compliance"
                    />
                    <div className="transform-card-overlay"></div>
                    <div className="transform-card-content">
                      <h5 className="fw-semibold">
                        Maritime Contracts & Compliance
                      </h5>
                      <p>
                        We assist with drafting, reviewing, and managing
                        shipping contracts, charter agreements, and compliance
                        documentation—ensuring full adherence to maritime
                        regulations.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    <img
                      ...
                      className="transform-card-img"
                      alt="Claims & Dispute Support"
                    />
                    <div className="transform-card-overlay"></div>
                    <div className="transform-card-content">
                      <h5 className="fw-semibold">Claims & Dispute Support</h5>
                      <p>
                        Our team provides paralegal support for cargo claims,
                        vessel damage, personal injury at sea, and insurance
                        disputes—helping attorneys prepare strong cases.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-12">
                  <div className="transform-card">
                    <img
                      ...
                      className="transform-card-img"
                      alt="Research & Litigation Support"
                    />
                    <div className="transform-card-overlay"></div>
                    <div className="transform-card-content">
                      <h5 className="fw-semibold">
                      ...
                      <p>
                        From case law research to trial preparation, we support
                        maritime attorneys with detailed analysis, document
                        drafting, and evidence management to strengthen
          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 col-md-10 order-0 order-lg-2">
              <div class="features__img">
                <img src="assets/img/special/Maritime.jpg" alt="img" />
              </div>
            </div>
            <div class="col-lg-7 col-md-10  ">
              <div class="features__content-two">
                <div class="section__title mb-25">
                  ...
                  <h2>Expert Maritime / Admiralty Law Paralegal Support </h2>
                  <p>
                    At Boulou LPO, our paralegals provide comprehensive maritime
                ...
                <ul class="list-wrap about__list-item-two">
                  <li>
                    ...
                    Drafting and reviewing vessel contracts, charter agreements,
                  ...
                  <li>
                    ...
                    Preparing filings, claims, and correspondence for admiralty
                    litigation
                  </li>
                  <li>
                    <div class="icon">
                  ...
                  <li>
                    ...
                    Coordinating communications with clients, insurers, and
                    regulatory agencies
                  </li>
                  <li>
                    <div class="icon">
                    ...
                    Conducting legal research on maritime law, regulations, and
                    case precedents
                  </li>
                  <li>
                    <div class="icon">
