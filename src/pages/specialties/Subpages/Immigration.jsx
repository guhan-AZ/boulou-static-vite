            ...
            <div class="col-lg-7 col-md-10  ">
              <div class="features__content-two">
                <div class="section__title mb-25">
                  ...
                  <h2>Expert Immigration Law Paralegal Support</h2>
                  <p>
                    At Boulou LPO, our paralegals provide comprehensive
                    immigration support, including:
                  </p>
                ...
                <ul class="list-wrap about__list-item-two">
                  <li>
                    ...
                    Preparing and filing visa petitions, green card
                    applications, and naturalization forms
                  </li>
                  <li>
                    <div class="icon">
                      <svg
                    ...
                    Drafting client affidavits and legal correspondence
                  </li>
                  <li>
                    <div class="icon">
                      <svg
                    ...
                    Organizing and submitting supporting evidence for USCIS or
                    consular processing
                  </li>
                  <li>
                    <div class="icon">
                    ...
                    Tracking deadlines and maintaining case status updates
                  </li>
                  <li>
                    <div class="icon">
                      <svg
                    ...
                    Coordinating biometrics appointments and interviews
                  </li>
                  <li>
                    <div class="icon">
                      <svg
                    ...
                    Conducting legal research on immigration policies and case
                    precedents
                  </li>
                </ul>
              </div>
