...
import tarnsportimg from "../../../../public/assets/lpo/transport.png";
import transport from "../../../../public/assets/img/special/Transportation.jpg";
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-8 col-md-12 hero-text-content">
              <div className="legal-hero-badge">
                Specialized and Affordable Legal Support
              </div>
              <h1 className="hero-title">Transportation & Logistics Law</h1>
              <p className="hero-description">
                Boulou LPO provides specialized paralegal support for attorneys
                working in transportation and logistics law. We assist with
                regulatory compliance, contracts, claims, and dispute
                management, helping firms handle complex legal matters related
            ...
            <div className="col-lg-4 col-md-12 hero-image-content">
              <div className="hero-main-image">
                <img src={tarnsportimg} alt="Lawyer" />
                {/* Floating Images */}
        ...
        <div className="container">
          <div className="row g-5 align-items-start">
            <div className="col-lg-6">
              ...
              >
                How We Can Transform <br /> Your Transportation Law Practice
              </h2>
            </div>
            <div className="col-lg-6">
              <h6 style={{ color: "#002688" }}>
                Streamlined Support for Contracts, Compliance, and Disputes
              </h6>
              <p className="transform-description text-muted">
                Transportation and logistics law cases often involve regulatory
                deadlines, detailed contracts, and claims management. Our team
                handles filings, research, and documentation management
                efficiently, freeing attorneys to focus on negotiations,
                advocacy, and litigation. This ensures compliance, reduces risk,
                and improves case outcomes.
              </p>
            </div>
                ...
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                        Reduce overhead and maximize revenue with cost-effective
                        paralegal support instead of hiring additional full-time
                        staff.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-12">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                        From contracts to compliance checks, our support team
                        manages essential tasks, freeing attorneys to focus on
                        strategy, advocacy, and building strong client
                ...
                <div className="row">
                  <div className="col-xl-8 col-lg-8">
                    ...
                    >
                      ...
                      <h4>
                        Driving Efficiency and Compliance in Transportation &
                        Logistics Law
                      </h4>
                      <p>
            ...
            <div className="col-lg-7 col-md-10">
              <div className="features__content-two">
                <div className="section__title mb-25">
                  ...
                  <h2>Expert Transportation & Logistics Paralegal Support</h2>
                  <p>
                    At Boulou LPO, our paralegals provide comprehensive support,
                    including:
                  </p>
