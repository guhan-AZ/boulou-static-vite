...
import Corporateimg1 from "../../../../public/assets/img/newimage/Corporate & Business Law.jpg";
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 col-md-12 hero-image-content">
              <div className="hero-main-image">
                <img src={Corporateimg1} alt="Corporate Law" />
              ...
              <p className="hero-caption">
                * At Boulou LPO, our paralegals provide comprehensive corporate
                and business law assistance, including: *
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row g-5 align-items-start">
            <div className="col-lg-6">
              ...
              >
                How We Can Transform Your Corporate & Business Law Practice
              </h2>
            </div>
            <div className="col-lg-6">
              ...
              <div className="row g-4">
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      <h5 className="fw-semibold">Efficient Compliance</h5>
                      <p>
                        We manage compliance filings with state and federal
                ...
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-overlay"></div>
                    <div className="transform-card-content">
                      <h5 className="fw-semibold">Contract Precision</h5>
                      <p>
                        Our paralegals draft and review contracts, NDAs, and
                        agreements with meticulous attention to detail.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="features__item-two">
                ...
                <div className="features__content-four">
                  ...
                  <p>
                    Paralegals experienced in corporate governance, contract
                    drafting, and business transactions.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="features__item-two">
                ...
                <div className="features__content-four">
                  ...
                  <p>
                    Knowledge of corporate compliance, filings, and document
                    management.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="features__item-two">
                ...
                <div className="features__content-four">
                  ...
                  <p>
                    Secure handling of sensitive corporate and financial
                    records.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-sm-6">
              <div className="features__item-two">
                ...
                <div className="features__content-four">
                  ...
                  <p>
                    Expand your capabilities without the overhead of additional
                    in-house staff.
                  </p>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-xl-8 col-lg-8">
                    ...
                    >
                      ...
                      <h4>Efficient Support for Growing Businesses</h4>
                      <p data-aos="fade-up" data-aos-delay="600">
                        Boulou LPO ensures your corporate and business law
                        matters progress smoothly and efficiently. We help you
                        deliver timely, accurate legal services that strengthen
                        your client relationships and enhance your firm’s
                        reputation.
                      </p>
                    </div>
                  </div>
            ...
            <div className="col-lg-7 col-md-10">
              <div className="features__content-two">
                <div className="section__title mb-25">
                  ...
                  <h2>Expert Corporate & Business Law Paralegal Support</h2>
                  <p>
                    At Boulou LPO, our paralegals provide comprehensive
                    corporate and business law assistance, including:
                  </p>
                </div>
                <ul className="list-wrap about__list-item-two">
                  <li>
                    ...
                    Drafting and reviewing contracts, NDAs, and partnership
                    agreements
                  </li>
                  <li>
                    <div className="icon">
                    ...
                    Preparing corporate formation and governance documents
                  </li>
                  <li>
                    <div className="icon">
                      <svg
                    ...
                    Managing compliance filings with state and federal agencies
                  </li>
                  <li>
                    <div className="icon">
                      <svg
                    ...
                    Organizing due diligence materials for mergers and
                    acquisitions
                  </li>
                  <li>
                    <div className="icon">
                  ...
                  <li>
                    ...
                    Conducting legal research on business regulations and case
                    law
                  </li>
                </ul>
              </div>
