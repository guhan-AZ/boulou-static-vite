...
import admininstration from "../../../../public/assets/lpo/administration-law.png"
...
import Administrativeimg from "../../../../public/assets/img/special/Administrative.jpg"
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-8 col-md-12 hero-text-content">
              ...
              <h1 className="hero-title">Administrative Law</h1>
              <p className="hero-description">
                Boulou LPO provides specialized paralegal assistance for
                administrative law attorneys, ensuring filings, correspondence,
                and case documentation are handled accurately and efficiently.
                From regulatory matters to hearings and appeals, we help
            ...
            <div className="col-lg-4 col-md-12 hero-image-content">
              <div className="hero-main-image">
                <img src={admininstration} alt="Lawyer" />
                {/* Floating Images */}
        ...
        <div className="container">
          <div className="row g-5 align-items-start">
            <div className="col-lg-6">
              ...
              >
                How We Can Transform <br /> Your Administrative Law Practice
              </h2>
            </div>
            <div className="col-lg-6">
              <h6 style={{ color: "#002688" }}>
                Streamlined Support for Regulatory and Administrative Matters
              </h6>
              <p className="transform-description text-muted">
                Administrative law cases often involve strict deadlines and
                detailed procedural requirements. Our team handles filings,
                research, and documentation management efficiently, freeing
                attorneys to focus on client strategy, hearings, and
                negotiations. This ensures compliance, reduces risk, and
                  ...
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                        ...
                        support <br />
                        that eliminates the expense of hiring full-time staff.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-12 col-sm-6">
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                        Connect with elite estate planning attorneys worldwide{" "}
                        <br />
                        and gain expertise trusted by leading law practices.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="transform-card">
                    ...
                    <div className="transform-card-content">
                      ...
                      <p>
                        ...
                        repetitive tasks and streamline estate planning
                        processes. <br />
                        By handling documentation, research, and compliance, we
                        free up valuable hours so you can focus on building
                        stronger client relationships <br />
                        and growing your practice with confidence.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="features__item-two">
                ...
                <div class="features__content-four">
                  ...
                  <p>
                    Paralegals experienced in administrative proceedings,
                    regulatory compliance, and agency filings.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="features__item-two">
                ...
                <div class="features__content-four">
                  ...
                  <p>
                    Knowledge of federal, state, and local administrative
            ...
            <div class="col-lg-6 col-sm-6">
              <div class="features__item-two">
                ...
                <div class="features__content-four">
                  ...
                  <p>
                    Secure handling of sensitive client and agency information.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-xl-8 col-lg-8">
                    ...
                    >
                      ...
                      <h4>
                        Reliable Support for Complex Administrative Matters
                      </h4>
                      <p data-aos="fade-up" data-aos-delay="600">
                        Boulou LPO ensures your administrative law practice
                        operates smoothly and efficiently. We help your firm
                        manage filings, deadlines, and communications
                        accurately, allowing your attorneys to provide strategic
                        guidance and advocacy with confidence.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 col-md-10 order-0 order-lg-2">
              <div class="features__img">
                <img src={Administrativeimg} alt="img" />
              </div>
            </div>
            <div class="col-lg-7 col-md-10 order-2 ">
              <div class="features__content-two">
                <div class="section__title mb-25">
                  <span class="sub-title">Types of Services We Offer </span>
                  <h2>Expert Administrative Law Paralegal Support </h2>
                  <p>
                    At Boulou LPO, our paralegals provide comprehensive
                    administrative law assistance, including:
                  </p>
                </div>
                ...
                <ul class="list-wrap about__list-item-two">
                  <li>
                    ...
                    Preparing and filing petitions, applications, and regulatory
                    submissions
                  </li>
                  <li>
                    <div class="icon">
                    ...
                    Drafting correspondence, notices, and responses to
                  ...
                  <li>
                    ...
                    Organizing case files, evidence, and supporting
                    documentation
                  </li>
                  <li>
                    <div class="icon">
                  ...
                  <li>
                    ...
                    Managing deadlines, hearings, and administrative calendars
                  </li>
                </ul>
              </div>
            </div>
